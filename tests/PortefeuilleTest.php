...
class PortefeuilleTest extends TestCase
{
    public function testCalculerValeurPortefeuille()
    {
        ...
        $transactionAchatMock1->method('getLaAction')->willReturn($actionMock1);
        ...
        $transactionVenteMock1->method('getLaAction')->willReturn($actionMock1);
        ...
        $transactionAchatMock2->method('getLaAction')->willReturn($actionMock2);
        ...
        $portefeuilleMock->method('getLesActions')->willReturn($actions);
        $portefeuilleMock->method('getLesTransactions')->willReturn($transactions);
